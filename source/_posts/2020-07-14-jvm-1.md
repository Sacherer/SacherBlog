---
title: 【JAVA】面试总结-理解Java类加载机制
date: 2020-07-14 11:17:40
tags:
  - Java
  - 面试
  - JVM
...
top: true
cover: true
img: /images/14923529-7ca333cbae4c1edd.png
categories: Java面试
---
#### 本文目的
...
![类的生命周期](/images/2020-07-14-11-21-14.png)
...
其目的确保 Class 文件的字节流中包含的信息符合当前虚拟机的要求，并且不会危害虚拟机自身的安全。
...
为类变量（static 修饰的变量）分配内存并设置类变量初始值，这些变量所使用的内存都将在方法区中进行分配。
...
- 如果类存在直接父类并且这个类还没有被初始化，那么就先初始化父类。
- 如果类中有存在初始化语句，就依次执行这些初始化语句。
...
- **Extension ClassLoader** （扩展类加载器）
  ...
  JAVA_HOME/lib/ext下的一些类

- **Application ClassLoader** （应用程序类加载器)

  ClassPath环境变量锁指定的路径中的类
...
![双亲委派模式](/images/14923529-7ca333cbae4c1edd.png)
...
[java new一个对象的过程中发生了什么 - 天风的文章 - 知乎](https://zhuanlan.zhihu.com/p/57515223)
